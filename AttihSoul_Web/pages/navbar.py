    ...
    return rx.box(
        rx.hstack(
            ...
            rx.hstack(
                ...
                rx.link("Setlist", href="/setlist", color=TEXT_WHITE, font_size="0.95rem", _hover={"color": GOLD}),
                spacing="6",
                align="center",
        ...
        rx.cond(
            ...
            rx.box(
                rx.vstack(
                    ...
                    rx.link("Setlist", href="/setlist", color=TEXT_WHITE, font_size="1.1rem", on_click=NavbarState.close_drawer, width="100%", padding="0.75rem 1.5rem", _hover={"color": GOLD, "background": "rgba(212,168,90,0.08)"}),
